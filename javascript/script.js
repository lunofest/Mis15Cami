...
function updateTimer() {
  const targetDate = new Date("january 11, 2025 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '541132167477'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '541156127861'; // Número para el primer botón
